...
describe("Start from one strategy", () => {
    ...
    const testCases = [
        ...
        {
            name: "From indent, downwards and continue",
            content: ["3. a", " 4. b", "1. c", "9. d"],
            startIndex: 1,
            expected: ["3. a", " 1. b", "4. c", "5. d"],
        },
        {
            name: "From indent, upwards",
            content: ["3. a", " 4. b", "  4. c"],
            startIndex: 1,
            expected: ["3. a", " 1. b", "  1. c"],
        },
        {
            name: "From indent, upwards",
            content: ["3. a", " 4. b", "  4. c", "  6. d"],
            startIndex: 1,
            expected: ["3. a", " 1. b", "  1. c", "  2. d"],
        },
        {
            name: "Indented - do not renumber downwards, first index",
